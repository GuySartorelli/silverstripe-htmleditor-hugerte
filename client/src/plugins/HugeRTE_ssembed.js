...
(() => {
  const ssembed = {
    init: (editor) => {
      const insertTitle = i18n._t('HugeRTE.INSERT_VIA_URL', 'Insert media via URL');
      const editTitle = i18n._t('HugeRTE.EDIT_MEDIA', 'Edit media');
      const deleteTitle = i18n._t('HugeRTE.DELETE_MEDIA', 'Delete media');
      const contextTitle = i18n._t('HugeRTE.MEDIA', 'Media');
      ...
      // Replace the hugerte default media commands with the ssembed command
  ...
  hugerte.PluginManager.add('ssembed', (editor) => ssembed.init(editor));
})();
