...
const plugin = {
  init(editor) {
    ...
    HugeRTEActionRegistrar.addAction('sslink', {
      text: i18n._t('HugeRTE.LINKLABEL_EXTERNALURL', 'Link to external URL'),
    ...
    renderModal(isOpen) {
      ...
      root.render(
        <InsertLinkExternalModal
          ...
          onClosed={handleHide}
          title={i18n._t('HugeRTE.LINK_EXTERNAL', 'Insert external link')}
...
hugerte.PluginManager.add('sslinkexternal', (editor) => plugin.init(editor));
