...
// eslint-disable-next-line import/no-unresolved -- webpack external from silverstripe/cms
...
const plugin = {
  init(editor) {
    ...
    HugeRTEActionRegistrar
      .addAction(
        'sslink',
        {
          text: i18n._t('HugeRTE.LINKLABEL_ANCHOR', 'Anchor on a page'),
      ...
      root.render(
        <Provider store={store}>
          <InsertLinkInternalModal
            ...
            onClosed={handleHide}
            title={i18n._t('HugeRTE.LINK_ANCHOR', 'Link to an anchor on a page')}
