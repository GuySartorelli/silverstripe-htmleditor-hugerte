...
/**
 * Acts as top level action registrar component for hugerte
 */
class HugeRTEActionRegistrar {
  constructor() {
    this.actions = {};
  ...
  addAction(menu, action, configId) {
    ...
    // To reduce upgrade pain from hugerte4 to hugerte6 (cms4 to cms5) we've added this
...
window.ss = window.ss || {};
window.ss.hugerteactions = window.ss.hugerteactions || new HugeRTEActionRegistrar();

export default window.ss.hugerteactions;
